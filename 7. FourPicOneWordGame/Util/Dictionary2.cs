...
namespace Util
{
    ...
    {
        private static Dictionary2 s_instance;
        private string[] words;

        public static Dictionary2 instance
        {
            get { return s_instance == null ? load() : s_instance; }
        }
        private Dictionary2(string[] words)
        {
            this.words = words;
        }
        ...
        public static Dictionary2 load()
        {
            if (s_instance != null)
                return s_instance;
            ...
            TextAsset asset = Resources.Load("Hazards") as TextAsset;
            ...
            s_instance = new Dictionary2(words);
            return s_instance;
